...
- [[11. MOV Attack & Frey–Rück Attack]]
...
| Miller's Algorithm                           | $O(\log n)$ tính $f_{n,P}$                            | [[07. Miller's Algorithm#Definition 7.4]]                |
| Weil = tỷ số hai Miller                      | $e_n(P,Q) = (-1)^n \cdot M(P,Q)/M(Q,P)$               | [[07. Miller's Algorithm#Theorem 7.7]]                   |
...
| MOV reduction                                | ECDLP → DLP trong $\mathbb{F}_{q^k}^*$                | [[11. MOV Attack & Frey–Rück Attack#Theorem 11.3]]              |
| BKSV anomalous attack                        | $O(\log^2 p)$ trên anomalous curves                   | [[11. MOV Attack & Frey–Rück Attack#Theorem 11.13]]             |
