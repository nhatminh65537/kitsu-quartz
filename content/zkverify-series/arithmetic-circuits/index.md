...
- [[03-arithmetic-circuits|03. Arithmetic Circuit — Definition & Structure]] — Định nghĩa DAG, gates ($+$, $\times$), wires, size/depth/fan-in/fan-out, Boolean vs Arithmetic, CSAT NP-complete, circuit cho $x^3+x+5$, sub-circuit reuse.
...
- [[05-constraint-systems-overview|05. Constraint Systems — Overview]] — Gate→constraint mapping, R1CS vs Plonkish vs AIR, pipeline đầy đủ Circuit→R1CS→QAP→Proof.
